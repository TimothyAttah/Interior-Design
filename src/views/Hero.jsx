    ...
    >
      <div className='relative w-full max-w-[1490px] flex items-center justify-between pt-10 mx-auto px-10'>
        ...
        >
          ...
          />
          <ul className='pt-[60px] flex items-center flex-col gap-8'>
      ...
      <div className='absolute h-[50px] xs:h-[150px] bottom-0 w-full bg-[linear-gradient(180deg,_#ffffff00_0%,#fff_100%)]' />
    </div>
  );
};
